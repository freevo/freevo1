 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class MoreActionsNavigationWidget extends CustomItem {
	...
	public MoreActionsNavigationWidget(Controller controller) {
		super(null);
		...
		icons[1][1] = loadImage("guide");
		icons[1][2] = loadImage("forward");
		
		icons[2][0] = loadImage("chanplus");
		icons[2][1] = loadImage("stop");
		icons[2][2] = loadImage("chanminus");

		icons[3][0] = loadImage("eject");
		icons[3][1] = loadImage("display");
		icons[3][2] = loadImage("record");
