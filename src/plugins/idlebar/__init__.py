...
class PluginInterface(plugin.DaemonPlugin):
    ...
    def take_space(self, space):
        ...
        """
        logger.log( 9, 'PluginInterface.take_space(space=%r)', space)
    ...
    def draw(self, (type, object), osd):
        ...
        """
        logger.log( 9, 'PluginInterface.draw(type=%r, object=%r, osd=%r)', type, object, osd)
        w = osd.width + 2 * osd.x
        h = osd.y + 60
    ...
    def poll(self):
        ...
        """
        logger.log( 9, 'PluginInterface.poll()')
        if skin.active():
            skin.redraw()
...
class IdleBarPlugin(plugin.Plugin):
    ...
    def __init__(self):
        ...
        """
        logger.log( 9, 'IdleBarPlugin.__init__()')
...
class clock(IdleBarPlugin):
    ...
    def __init__(self, format=''):
        ...
        """
        logger.log( 9, 'clock.__init__(format=%r)', format)
    ...
    def draw(self, (type, object), x, osd):
        ...
        Draw the clock
        """
        logger.log( 9, 'clock.draw(type=%r, object=%r, x=%r, osd=%r)', type, object, x, osd)
...
class logo(IdleBarPlugin):
    ...
    def __init__(self, image=None):
        ...
        """
        logger.log( 9, 'logo.__init__(image=%r)', image)
        IdleBarPlugin.__init__(self)
        self.image = image
    ...
    def draw(self, (type, object), x, osd):
        """ Draw the logo """
        logger.log( 9, 'logo.draw(type=%r, object=%r, x=%r, osd=%r)', type, object, x, osd)
        if not self.image:
